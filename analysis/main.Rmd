...
(
  exp_val_car_hit <- mutate(
    ...
    exp_val_car_per_hour = total_car_per_hour$exp_val_car_per_hour,
    time_exp_val_per_hour = expected_value * total_car_per_hour$exp_val_car_per_hour
  ) %>% # reorder the columns
    select( 
      hour,
      events,
      ...
      exp_val_car_per_hour,
      expected_value,
      time_exp_val_per_hour
    )
)
...
(prob_car_hit <- sum(exp_val_car_hit$time_exp_val_per_hour))
```
