...
#     global mass_in_net, num_boulder_through_net
#     broken = False
...
#                     car_hitting(now, day_minutes)
#                     break
    # prob = num_boulder_through_net/num_of_simulations
    # print('probability:', prob)
    # print('failures: ', num_boulder_through_net)
...
monte_carlo_rockfall <- function(num_of_years, clearing_time_hour) {
  ...
  # prob <- num_boulder_through_net / num_of_years
  # cat("probability: ", prob)
  # cat("num_rock_through_net: ", num_boulder_through_net)
  # cat("car hit stat: ", car_hit_stat)
  # cat("car hit even: ", car_hit_even)
  # cat("car hit max: ", car_hit_max)
...
```{r}
monte_carlo_rockfall(num_of_years = 5000, clearing_time_hour = 8)
```
