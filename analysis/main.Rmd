...
# Parse hour column
hours <- str_split_fixed(data_traffic$hour, " ", n = 2)[, 1] # get the names
data_traffic[, 1] <- hours # replace old values with new ones
data_traffic

# Parse column time into time format
#data01$time <- hms(time)
```
